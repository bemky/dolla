 ...
 * 
 * @param {string} [tagName="div"] - A String declaring what type of HTML tag to create
 * @param {Object} [attributes={}] - An Object whose keys are used to set attributes on the created element. All HTMLElement attributes are accepted including an additional option to define `content`
 ...
 * @param {string} [namespace] - A String declaring the namespaceURI
