 ...
 * 
 * @param {NodeList|HTMLCollection|Array} elements - A NodeList, HTMLCollection, or Array to sort
 * @param {Function} compareFn - A function that returns a negative number if arg1 before arg2 or positive if after
 * @returns {undefined}
 * 
 * @example
